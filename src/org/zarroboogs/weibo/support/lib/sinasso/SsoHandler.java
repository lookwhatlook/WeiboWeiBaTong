package org.zarroboogs.weibo.support.lib.sinasso;
...
public class SsoHandler {
	...
	private static final String WEIBO_SIGNATURE = "30820295308201fea00302010202044b4ef1bf300d"
			...
			+ "2fb8795f736a20c95cda776402099054fccefb4a1a558664ab8d637288feceba9508aa907fc1fe2" + "b1ae5a0dec954ed831c0bea4";
	...
	private boolean startSingleSignOn(Activity activity, String[] permissions, int activityCode) {
		...
		intent.putExtra("appKey", WeiBoURLs.APP_KEY);
		intent.putExtra("redirectUri", WeiBoURLs.DIRECT_URL);
