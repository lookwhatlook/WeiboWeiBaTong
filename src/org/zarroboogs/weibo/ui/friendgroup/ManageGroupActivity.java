...
public class ManageGroupActivity extends AbstractAppActivity {
	...
	public static class ManageGroupFragment extends ListFragment {
		...
		public void addGroup(String groupName) {
			new CreateGroupTask(GlobalContext.getInstance().getSpecialToken(), groupName).executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
		}

		public void modifyGroupName(String idstr, String groupName) {
			new ModifyGroupNameTask(GlobalContext.getInstance().getSpecialToken(), idstr, groupName).executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
		}

		public void removeGroup(List<String> groupNames) {
			new RemoveGroupTask(GlobalContext.getInstance().getSpecialToken(), groupNames).executeOnExecutor(MyAsyncTask.THREAD_POOL_EXECUTOR);
		}
