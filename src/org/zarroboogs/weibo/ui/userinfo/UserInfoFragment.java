...
import org.zarroboogs.weibo.database.MyStatusDBTask;
import org.zarroboogs.weibo.database.TopicDBTask;
...
import org.zarroboogs.weibo.ui.topic.UserTopicListActivity;
...
public class UserInfoFragment extends AbstractMessageTimeLineFragment<MessageListBean> implements MainTimeLineActivity.ScrollableListFragment,
	...
	private void displayBasicInfo() {
		...
		avatar.getImageView().post(new Runnable() {
			...
			public void run() {
				...
				TimeLineBitmapDownloader.getInstance().display(avatar.getImageView(), avatar.getImageView().getWidth(), avatar.getImageView().getHeight(),
	...
	private void displayCoverPicture() {
		...
		TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, -100f,
	...
	private void setListViewPositionFromPositionsCache() {
		...
		Utility.setListViewSelectionFromTop(getListView(), position != null ? position.position : 0, position != null ? position.top : 0);
