...
public class FriendsTimeLineDBTask {
	...
	private static void reduceHomeTable(String accountId) {
		String searchCount = "select count(" + HomeTable.HomeDataTable.ID + ") as total" + " from " + HomeTable.HomeDataTable.TABLE_NAME + " where "
	...
	private static void updateCount(String msgId, int commentCount, int repostCount) {
		String sql = "select * from " + HomeTable.HomeDataTable.TABLE_NAME + " where " + HomeTable.HomeDataTable.MBLOGID + "  = " + msgId + " order by "
	...
	private static MessageListBean getHomeLineMsgList(String accountId, int limitCount) {
		...
		String sql = "select * from " + HomeTable.HomeDataTable.TABLE_NAME + " where " + HomeTable.HomeDataTable.ACCOUNTID + "  = " + accountId + " order by "
